...
def go(args):
    ...
    # trainval_local_path = # YOUR CODE HERE - done

    logger.info(
        f"Fetching the train and validation artifact {args.trainval_artifact}:latest")
    trainval_local_path = run.use_artifact(
        f"{args.trainval_artifact}:latest").file()
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # non_ordinal_categorical_preproc = # YOUR CODE HERE- done
